...
def is_lerobot_dataset(dataset_path: str) -> bool:
    return (
        "gr1" in dataset_path.lower()
        or "g1" in dataset_path.lower()
        or "yam" in dataset_path.lower()
        or "agibot" in dataset_path.lower()
        or "piper" in dataset_path.lower()
    )
...
class VideoActionDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, data_id):
        ...
        data = {
            ...
            "fps": lerobot_data.get("fps", self.fps),
...
class MultiVideoActionDataset(torch.utils.data.Dataset):
    def __init__(
        ...
        if args is not None:
            ...
            video_key = getattr(args, "video_key", video_key)
