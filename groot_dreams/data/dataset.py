...
class LeRobotSingleDataset(Dataset):
    ...
    def _get_metadata(self, embodiment_tag: EmbodimentTag) -> DatasetMetadata:
        ...
        elif embodiment_tag == EmbodimentTag.PIPER:
...
class WrappedLeRobotSingleDataset(LeRobotSingleDataset):
    def __init__(self, *args, data_split="full", fps=4, **kwargs):
        self.fps = fps
        super().__init__(*args, **kwargs)
    ...
    def __getitem__(self, index: int) -> dict:
        ...
        try:
            ...
            elif "piper" in str(self.dataset_path).lower():
                action_seq[:, 169:183] = delta_actions
